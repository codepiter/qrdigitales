...
Route::resource('webs', WebController::class)-> except(['show'])-> middleware ('auth')->middleware('verified');

//Route::resource('webs', 'WebController', ['except'=>['show']])-> middleware ('auth')->middleware('verified');

//Route::get('webs/{page:slug}', 'WebController@show')->name('webs.show');
Route::get('webs/{web:slug}', 'WebController@show')->name('webs.show');

Route::post('sendemail', 'WebController@sendEmail')->name('sendemail');


//Route::get('/send-email', [WebController::class, 'sendEmail']);
