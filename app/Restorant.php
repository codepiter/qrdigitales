...
class Restorant extends MyModel
{
    ...
    {
        return $this->getImge($this->getConfig('resto_wide_logo',null),config('global.site_logo'),'_original.png' );
    }

    public function getLogowidedarkAttribute()
    {
        return $this->getImge($this->getConfig('resto_wide_logo_dark',null), config('global.site_logo'),'_original.png' );
    }
    ...
    {
        return $this->hasMany(\App\User::class, 'restaurant_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Webs::class, 'restaurant_id', 'id');
    }
    ...
    public static function boot()
    {
        ...
        self::deleting(function (self $restaurant) {
            if (config('settings.is_demo')) {
                ...
                //No need for this since we have Soft Delete now 2.5.2
                /*//Delete Categories 
